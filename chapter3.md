...
Next Up: We will explore the physical layout of LUMI—understanding that not all "parts" of the supercomputer are created equal.
[Chapter 4: Navigating LUMI (Nodes and Storage) ➡️](./chapter4.md)