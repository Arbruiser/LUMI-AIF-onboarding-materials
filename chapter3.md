...
If you are more of an auditory learner or if this guide simply wasn't enough for you, please watch this [video guide](https://www.youtube.com/watch?v=16d2lHc0Pe8).
...
10. Great job! Now you can disconnect from LUMI by pressing **ctrl+D**. The command prompt has changed to `your_username_on_your_computer @ the_name_of_your_computer`, which means that you're back to **your machine** in the terminal. 