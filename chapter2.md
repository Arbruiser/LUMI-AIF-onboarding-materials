...
{: .note }
> Why don't we just use passwords?
...
{: .note } 
> Pro-Tip: When the guide asks you for a "passphrase," choose something you can remember. This adds a second layer of security: even if someone stole your laptop, they couldn't use your key without that phrase.
...
![Logging into LUMI in terminal](assets/images/LUMI_logged_in_terminal.png)
...
![Logging into LUMI command line via web interface](assets/images/LUMI_logged_in_browser.png)
